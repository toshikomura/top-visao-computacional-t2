...
int main(int argc, char* argv[])
{
    ...
    for(int i = 0;;++i)
    {
      ...
      //cout << "a Here --\"" << mode << " - " << CAPTURING << "\" " << imagePoints.size() << " >= " << (unsigned)s.nrFrames << endl;
      ...
      if(view.empty())          // If no more images then run calibration, save and stop loop.
      {
            ...
            //cout << "AAAAAAAAA " << imagePoints.size() << endl;
        ...
        //cout << "------------- aaaaaaaaaaaaaaaa " << imageSize.width << " " << imageSize.height << endl;
        ...
        //cout << "a Here --\"" << mode << " - " << CALIBRATED << "\" " << s.showUndistorsed << endl;
    ...
    {
        Mat view, rview, map1, map2, cali;
        //cout << "Here --\"" << cameraMatrix << "\"" << endl;
        imwrite("Test.jpg", cameraMatrix);
        cali = getOptimalNewCameraMatrix(cameraMatrix, distCoeffs, imageSize, 1.0, imageSize, 0);
        initUndistortRectifyMap(cameraMatrix, distCoeffs, Mat(), cali, imageSize, CV_16SC2, map1, map2);


        for(int i = 0; i < (int)s.imageList.size(); i++ )
        {
            //cout << "i = " << i << " < " << (int)s.imageList.size() << endl;
